    ...
    <Layout id='about'>
      <div className="bg-gray-50 py-12 h-full">
        <div className="flex flex-col items-center justify-around h-full px-4 sm:px-8 md:px-16 lg:px-32 xl:px-48">
          <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-5xl font-bold mt-8 mb-4">Sobre</h2>
          <section className="flex flex-col self-center w-5/6 md:w-[40vw] mb-6">
            <h2 className="text-md md:text-xl lg:text-3xl text-center font-semibold mb-4 md:mb-12">Actividade Profissional</h2>
            <p className="text-gray-700 text-sm md:text-md lg:text-lg mb-6">
              <a href="https://catolicabs.porto.ucp.pt/pt-pt/career-and-development-office?change-language=1" className="font-bold underline">Católica Porto Business School</a> | Orientação Vocacional, Gestão de Carreira e Aprendizagem ao Longo da Vida
            </p>
            <p className="text-gray-700 text-sm md:text-md lg:text-lg mb-6">
              <a href="https://consultorio-de-psicologia-do-porto.negocio.site/" className="font-bold underline">Consultório de Psicologia do Porto</a> | Psicologia Clínica e Orientação Vocacional
            </p>
            <p className="text-gray-700 text-sm md:text-md lg:text-lg">
              <a href="https://www.linkedin.com/company/consultoriodepsicologiaporto/about/" className="font-bold underline">Consultório de Psicologia Porto</a> | Psicologia Clínica e Orientação Vocacional
            </p>
          </section>
          <section className="flex flex-col self-center w-5/6 md:w-[40vw]">
            <h2 className="text-md md:text-xl lg:text-3xl text-center font-semibold mb-4 md:mb-12">Áreas de Intervenção e destinatários</h2>
            <p className="text-gray-700 text-sm md:text-md lg:text-lg mb-6">
